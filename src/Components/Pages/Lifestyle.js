...
const Lifestyle = () => {
  ...
  const lifestyleData = useSelector((state) => state?.subcategory?.cateData?.categoryData);
  console.log('Business-DATA~~~~~~~~~~~~~', lifestyleData)
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-lg-8">
                    {lifestyleData && lifestyleData.map((item) => (
                      <div className="row">
